...
<section id="supply" class="py-12">
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <p class="mt-4 text-gray-700">
            ...
            large urban areas, while many affluent communes continue to
            under‑produce. These charts show both the overall rise in supply and
            the ways in which territory still structures who gets access to HLM.
        </p>
    </div>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <p class="mt-4 text-gray-700">
            ...
            pressures, host a large share of the national stock. Others remain
            well below national averages, illustrating how historical planning
            choices, local politics, and land markets shape where low‑income
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <p class="mt-4 text-gray-700">
            ...
            identify territories that exceed, meet, or fall far short of the
            law’s targets. The map is a tool for visualizing spatial
            inequalities in access to social housing at multiple scales and over
            time.
        </p>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <p class="mt-4 text-gray-700">
            ...
            declared non‑compliant and thus subject to financial penalties or a
            temporary loss of control over building permits. It highlights the
            persistence of local resistance and the limits of enforcement
            mechanisms.
        </p>
    </div>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <p class="mt-4 text-gray-700">
            ...
            formal SRU rates, the quantitative indicators often mask severe
            overcrowding, informal settlements, and inadequate infrastructure.
            Focusing on places like French Guiana shows how the housing question
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <p class="mt-4 text-gray-700">
            ...
            others reserve it for the poorest households or have dramatically
            reduced their stock. Comparing these models helps situate the SRU
            law within a wider debate about how states use housing policy to

...
export const residentTopicsFr = [
  {
    ...
    "quotes": [
      ...
      "J’ai pleuré le jour où j’ai vu la beauté de l'appartement et de la vue depuis mon balcon. Ça a pu élargir le champ des possibles.",
      "J'ai un grand studio, j'ai une vue incroyable avec un petit balcon. Je vois la Tour Eiffel, le Louvre, le Sacré Cœur, la tour Montparnasse, un bout de la Seine.",
      "Ça nourrit l'âme. Je suis très fière d'habiter là.",
      "Ma fille a même pu trouver du travail à la Samaritaine, et ça l’a rendue très fière. C’est aussi une certaine fierté pour mes filles d’habiter la Samaritaine."
    ]
  },
  {
    ...
    "quotes": [
      ...
      "Parfois la foule c’est un peu trop, mais ça n’a pas de prix d’être au cœur de la ville. On est à proximité de tout—à l’exception des grandes surfaces.",
      "J’ai toujours fait mes courses au marché d'Aligre. Ça me convient tout à fait. C’est quand même un peu loin et je dois prendre le métro, donc on est obligés d'être à deux si je suis chargée au niveau du chariot.",
      "Il y a un marché le dimanche matin rue de Montmartre, mais c'est rédhibitoire au niveau des prix.",
      "C'est un quartier-vitrine. Donc, il y a énormément de touristes. Ça reste dédié à une clientèle touristique."
    ]
  },
  {
    ...
    "quotes": [
      ...
      "Je suis pour la médecine de proximité, mais il est impossible de trouver un nouveau médecin traitant dans le quartier. Alors je consulte chez mon médecin traitant là ou j’habitais avant. Ici, les médecins refusent tous de prendre de nouveaux patients.",
      "Par contre, pour tous les autres soins, je vais à côté. J'ai trouvé une super dentiste. Ophtalmologue, pareil. Centre de radios, pareil. Il y a énormément de centres de soins qui ne sont pas forcément bon marché, que je trouve très luxueux, mais ça me dépanne pour le moment."
    ]
  },
  {
    "id": "thermal-comfort",
    ...
    "quotes": [
      ...
      "À la Tour Bois-le-Prêtre, quand les balcons ont été rajoutés par les architectes, pendant longtemps les voisins avaient peur de s’y aventurer pour s’y mettre au frais et apprécier la vue. Ça leur donnait le vertige.",
      "Ils nous ont installé ces beaux rideaux thermiques qui demandent un minimum de savoir-faire pour l’entretien quotidien. Beaucoup de mes voisins oublient de les ouvrir et d’aérer tout l’appartement au moins dix minutes par jour.",
      "Ici, ça devait être l'étage des réserves. Donc, notre appartement est mansardé, avec une sous-pente. On est sous le toit en zinc. Donc, effectivement, l'été, toute l’enveloppe est chaude, parfois brûlante."
    ]
  },
  {
    "id": "cultural-capital",
